...
set.seed(1024)
source(here::here("autograder/ls05_boxplots_autograder.R"))
```
...
![Anatomy of a boxplot](images/boxplot_anatomy.png){width="757"}
...
```{r}
# Load packages
pacman::p_load(tidyverse, here, gapminder)
```
